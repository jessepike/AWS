...
| **Stage** | Operate & Evolve — Medium maturity (v0.1.0) |
...
| **Stage** | Operate & Evolve — Medium maturity |
...
| **Memory** | Operate & Evolve | MCP (15 tools), SQLite+Chroma, local embeddings, consolidation | — | Cross-query with KB (low priority) |
| **Krypton** | Operate & Evolve | 4 commands, 3 gatherers, 2 hooks, redaction, 27+4 tests | Governance health check (B2), expanded capture routing (B3) | Work Mgmt integration |
| **Capabilities Registry** | Operate & Evolve | INVENTORY.md, scripts, MCP installers, freshness tracking | — | No standalone MCP server |
| **Link Triage** | Operate & Evolve | Pipeline, classification, Raindrop integration, KB capture, 160 tests | Krypton routing integration (B3) | — |
